...
func TestDecodeATCAdvertisement_Valid(t *testing.T) {
	...
	// Temperature: 22.5°C (225 in 0.1°C = 0x00E1 big endian = 00 E1)
	// Humidity: 65% (0x41)
	// Battery: 95% (0x5F)
	...
	data := []byte{
		...
		0x00, 0xE1, // Temperature: 225 * 0.1 = 22.5°C (big endian)
		0x41,       // Humidity: 65%
		0x5F,       // Battery: 95%
...
func TestDecodeATCAdvertisement_NegativeTemperature(t *testing.T) {
	...
	// -10.5 * 10 = -105 = 0xFF97 (two's complement, big endian)
	data := []byte{
		0xA4, 0xC1, 0x38, 0x12, 0x34, 0x56, // MAC
		0xFF, 0x97, // Temperature: -105 * 0.1 = -10.5°C (big endian)
		0x50,       // Humidity: 80%
		0x64,       // Battery: 100%
...
func TestDecodeATCAdvertisement_ExtremeRSSI(t *testing.T) {
	data := []byte{
		0xA4, 0xC1, 0x38, 0x12, 0x34, 0x56,
		0x00, 0xE1, // Temperature in big endian
		0x41,
		0x5F,
		0xB8, 0x0B,
		0x2A,
